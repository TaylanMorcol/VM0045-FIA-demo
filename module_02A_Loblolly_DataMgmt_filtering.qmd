...
![Ecological section 232J (blue fill) interects four US states: North Carolina, South Carolina, Georgia, and Florida. Blue fill and yellow state boundaries added for clarity. Map excerpt from Cleland et al., (2007), https://doi.org/10.2737/WO-GTR-76D.](/images/Cleland_map_cropped_blue232J_yellowStateLinesChatGPT_20251116.png){width=70%}
...
# APPENDIX: USING GENERATIVE AI TOOLS
...
### trial #3
I decided to give it one more try. This time, I provided a vector/SVG file--rather than a raster-type file--of the raw map image. My hope was that, because the boundary lines are explicitly defined in a vector image, the AI tool would have an easier time identifying these boundaries. I also provided the same raster/PNG example image as before, along with this prompt:
